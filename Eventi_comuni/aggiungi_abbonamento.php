<?php
        ...
        if(isset($_POST['registra_abbonamento'])){
    ...
    <body>
        <div class="titolo">aggiungi abbonamento</div>
        <div class="action"><button onclick="location.href='gestisci_abbonamenti.php?username=<?php echo $username ?>'">torna indietro</button>
        ...
        <button onclick="document.getElementById('submit').click()">registra abbonamento</button> 
    </body>
    </html>
