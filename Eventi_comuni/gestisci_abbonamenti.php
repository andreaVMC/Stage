...
<head>
    ...
    <title>gestisci abbonamenti</title>
    <style>
...
<body>
    <div class="titolo">gestisci abbonamenti</div>
    <div class="action"><button onclick="location.href='comuniDashboard.php?username=<?php echo $username ?>'">dashboard</button>
    <button onclick="location.href='aggiungi_abbonamento.php?username=<?php echo $username ?>'">aggiungi abbonamento</button></div>
        ...
        <table>
            ...
            <?php
                ...
                foreach ($abbonamenti as $abbonamento){
                        echo "<tr>";
                        echo "<td style=\"text-align:center;\">".$abbonamento['Id']."</td>";
                        echo "<td style=\"text-align:center;\">".$abbonamento['tipo']."</td>";  
                        echo "<td style=\"text-align:center;\">". $abbonamento['anno'] ."</td>";
                        ?>
                        <td style="text-align:center;"><input type="checkbox" name="elimina[]" value="<?php echo $abbonamento['Id'];?>"></td>
                        <?php
                        echo "</tr>";
                }
            ?>
